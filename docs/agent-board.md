...
| `003-backend-simulation-api.md` | Done | Backend Worker | QA Reviewer | `backend/src/main/java`, `backend/src/test/java`, `backend/build.gradle` | PR merge 후 master에서 backend clean test build 통과; 최종 기록 완료 |
