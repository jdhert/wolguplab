...
| `003-backend-simulation-api.md` | Draft | Backend Worker | QA Reviewer | `backend/src/main/java`, `backend/src/test/java`, `backend/build.gradle` | 002 Mock 타입 참고 필요 |
| `004-docker-compose.md` | Draft | Infra Worker | Integrator | `docker-compose.yml`, `frontend/Dockerfile`, `backend/Dockerfile`, `.env.example` | Backend API 이후 통합 |
